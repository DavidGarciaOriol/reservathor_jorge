...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md {{ Auth::check()?'navbar-light bg-success':'navbar-light bg-warning' }} navbar-laravel">
            <div class="container">
                    ...
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                              <a class="dropdown-item" href="{{ route('rooms.index') }}">List</a>
                              @auth
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                              <a class="dropdown-item" href="{{ route('types.index') }}">Show All</a>
                            </div>
                        </li>
                        @auth
                        <li class="nav-item dropdown">
